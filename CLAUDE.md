...
> 3. **Scoopulator URL format:** `https://scoopulator.app/calc?ingredients=slug1:weight1,slug2:weight2,...&type=TYPE` where TYPE is one of: `ice_cream`, `frozen_yogurt`, `gelato`, `sherbet`, `sorbet`, `ganache`, `other`. Try to guess the TYPE from the recipe and ingredients (sweeteners/no sugar, no/low fat, sorbet, sherbet etc), dont just try to match whatever gives more green stats.
...
> Source: `rest/scoopulator_profiles_index.json` (scraped from Scoopify). All values are fractions (multiply by 100 for %).

### Ice Cream Profiles

| Slug | Name | Milk Fat | Sugars | MSNF | Stabilizers | Emulsifiers | Total Solids | Serving °C |
|------|------|----------|--------|------|-------------|-------------|--------------|-----------|
| `general-ice-cream` | General | 5-18% | 11-17% | 7-15% | 0-0.3% | 0.1-0.8% | 35-45% | -16 to -12 |
| `superpremium-ice-cream` | Superpremium | 14-18% | 14-17% | 5-8% | 0-0.2% | 0.1-0.8% | 40-42% | -16 to -12 |
| `premium-ice-cream` | Premium | 12-14% | 13-16% | 8-10% | 0.2-0.4% | 0.1-0.8% | 38-40% | -16 to -12 |
| `standard-ice-cream` | Standard | 10-12% | 14-17% | 9-10% | 0.2-0.4% | 0.1-0.8% | 36-38% | -16 to -12 |
| `reduced-fat-ice-cream` | Reduced Fat | 7-9% | 18-19% | 10-12% | 0.3-0.5% | 0.1-0.8% | 32-36% | -16 to -12 |
| `light-ice-cream` | Light | 5-7% | 18-20% | 11-12% | 0.4-0.6% | 0.1-0.8% | 30-35% | -16 to -12 |
| `low-fat-ice-cream` | Low Fat | 2-5% | 18-21% | 12-14% | 0.7-0.9% | 0.1-0.8% | 28-32% | -16 to -12 |
| `nonfat-ice-cream` | Nonfat | 0-0.5% | 18-22% | 12-14% | 0.9-1.1% | 0.1-0.8% | 28-32% | -16 to -12 |
| `soft-serve` | Soft Serve | 4-7% | 13-15% | 11-14% | 0-0.3% | 0.1-0.2% | 34-38% | -16 to -12 |

### Other Profiles

| Slug | Name | Milk Fat | Sugars | MSNF | Stabilizers | Emulsifiers | Total Solids | Serving °C |
|------|------|----------|--------|------|-------------|-------------|--------------|-----------|
| `gelato` | Gelato | 4-8% | 16-22% | 11-12% | 0.4-0.6% | 0.1-0.8% | 36-43% | -14 to -10 |
| `frozen-yogurt-regular` | Froyo Regular | 3-6% | 15-17% | 9-13% | 0.4-0.6% | 0.1-0.8% | 30-36% | -16 to -12 |
| `frozen-yogurt-nonfat` | Froyo Nonfat | 0-0.5% | 15-17% | 9-14% | 0.5-0.7% | 0.1-0.8% | 28-32% | -16 to -12 |
| `sherbet` | Sherbet | 1-2% | 22-28% | 1-3% | 0.4-0.5% | 0.1-0.8% | 28-34% | -16 to -12 |
| `sorbet` | Sorbet | 0-2% | 22-28% | 0-3% | 0.3-0.5% | 0.1-0.8% | 28-34% | -16 to -12 |
| `ganache` | Ganache | 15-25% | 25-45% | — | 0.3-0.5% | — | 60-75% | — |
| `freeform` | Freeform | — | — | — | — | — | — | — |

**Key pattern:** As fat decreases, sugars + MSNF + stabilizers must increase to compensate for lost body/texture. Gelato has warmest serving temp (-14 to -10°C).

...
9. **Always paste the clickable Scoopulator URL** after every validation summary. The user should never have to ask for it. Format: `[Scoopulator](<full URL>)` on its own line right after the one-line summary.
